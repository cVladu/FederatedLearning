...
def main():
    ...
    dh_train = DatasetHandlerClass("/home/cvladu/data/federated_learning/FederatedLearning/data/RWF-2000_npy/train")
    dh_val = DatasetHandlerClass("/home/cvladu/data/federated_learning/FederatedLearning/data/RWF-2000_npy/val")
    ...
    models_path = "/home/cvladu/data/federated_learning/FederatedLearning/logs"
    callbacks = [
